...
import type { Member, PendingInvitation, MemberRole, InviteMemberData } from '@/types/member';
import { ROLE_HIERARCHY } from '@/types/member';
import InviteMemberDialog from './InviteMemberDialog'; // <-- CORRECTED import name
import { useInviteMember } from '@/hooks/useMember'; // <-- ADDED import
...
export default function MemberList({
  ...
  const [isInviteOpen, setIsInviteOpen] = useState(false); // <-- ADDED
  const inviteMutation = useInviteMember(workspaceSlug); // <-- ADDED
