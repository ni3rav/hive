...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '@/components/accordion-animated';
...
export function MetadataForm({
  ...
  React.useEffect(() => {
    const serializableMetadata = {
      ...metadata,
      publishedAt: metadata.publishedAt ? new Date(metadata.publishedAt).toISOString() : null,
    };
        ...
        <AccordionContent>
          <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-[120px_1fr] md:items-center gap-x-6 gap-y-6 text-sm">
              ...
              <Input readOnly className={cn('h-9', formFieldClasses, readOnlyClasses)} value={metadata.slug} />
              ...
              <div className="relative flex items-center">
                ...
                <Input className={cn('h-9 w-full pl-10', formFieldClasses)} placeholder="Select a category" />
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <Input className={cn('h-9 w-full pl-10', formFieldClasses)} placeholder="Select some tags" />
              </div>
            </div>
          </div>
        </AccordionContent>
