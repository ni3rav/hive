...
export function Features() {
  ...
  return (
    <section id='features' className='relative border-t border-border/40 py-28'>
          ...
          {features.map((f, index) => (
            ...
            >
              ...
              <div className='hidden lg:block'>
                <h3
                  className={`font-medium tracking-tight ${activeIndex === index ? 'text-foreground' : 'text-muted-foreground'}`}
                >
                  {f.title}
                </h3>
              </div>
