...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <p className="ag-item text-lg text-muted-foreground leading-relaxed">
            Plan, write, optimize and publish with clarity. A focused toolkit that removes
            operational friction from your content workflow.
          </p>
      ...
      <noscript>
        {/* Fallback so text still shows if JS disabled */}
